...
**Windows Scripts:**
- `install.bat` - Complete dependency installation with error checking
- `run.bat` - Application launcher with auto-install check
- `generate-pdf.bat` - Example PDF generator

**macOS/Linux Scripts:**
- `install.sh` - Complete dependency installation with color-coded output
- `run.sh` - Application launcher with auto-install check
- `generate-pdf.sh` - Example PDF generator
...
2. Double-click generate-pdf.bat
